...
문의: [기획단 안내 페이지](https://example.com)`,
  ...
  },
  {
    ...
    title: '폐쇄 구간 안내 (백양로)',
    content:
      '5/28~29 백양로 메인스테이지 인근(공학원 ~ 백양관) 차량 진입이 전면 통제됩니다. 보행자도 메인 무대 리허설 시간(13:00-14:00, 16:00-17:00) 에는 우회 부탁드립니다.',
    date: '2026-05-15',
    hasImage: true,
  },
  {
    ...
    title: '시상식 / 폐회식 안내',
    content:
      '5/29(금) 21:30 백양로 메인스테이지에서 폐회식과 부스 시상식 진행. 부스 운영자분들은 21:00까지 부스 정리 후 메인스테이지 앞으로 모여주세요.',
    date: '2026-05-12',
    hasImage: true,
  },
  {
