    ...
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-2">비활성화된 유저를 관리합니다.</p>
        </div>
          ...
          <thead className="bg-muted border-b border">
            <tr>
              <th className="w-12 py-4 text-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded accent-ds-success"
                />
              </th>
              ...
              <th className="px-6 py-4 text-left text-sm font-semibold text-foreground">비활성일</th>
            </tr>
          </thead>
          <tbody>
            {filteredUsers.map((user, index) => (
              ...
              >
                ...
                <td className="px-6 py-4 text-sm text-muted-foreground">{user.deactivatedDate}</td>
              </tr>
            ))}
          </tbody>
        </table>
