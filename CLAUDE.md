...
이 어드민이 운영하는 실제 행사의 기준 메타데이터. 공지/배너/메일 문구·일정 계산·캠퍼스 분기 로직의 **Single Source of Truth**다. 값을 하드코딩하기 전에 여기 값과 맞는지 먼저 확인할 것.

| 항목 | 값 |
|---|---|
| 공식 명칭 | 개교 제141주년 무악대동제 |
| 축제 테마명 | `UNIT:Y` (표기는 `<UNIT:Y>`, 꺾쇠+콜론 포함) |
| 슬로건 | 너와 내가 하나되는 연세의 축제 |
| 주최 | 개교 제141주년 무악대동제 〈UNIT:Y〉 기획단 |
| 개교 연차 | 141주년 |
...
| 날짜 | 요일 | 캠퍼스 | 프로그램 |
|---|---|---|---|
| 5월 26일 | 화 | — | 블루런 *(총학생회 체육부 공동 주최)* |
| 5월 27일 | 수 | 국제캠퍼스(송도) | 워터슬라이드 등 액티비티 · 공연 · 먹거리 |
| 5월 28일 | 목 | 신촌캠퍼스(백양로) | 부스 · 공연 |
| 5월 29일 | 금 | 신촌캠퍼스(백양로) | 부스 · 공연 |

### 카피 핵심 컨셉

> "흩어져 있던 청춘의 조각들이 한 곳에 모여 각자의 색으로 하나의 장면을 완성"
> → **개별성(각자의 색) × 통합(UNIT:Y, 하나)** 이 핵심 메타포. 공지/마케팅 톤은 이 축을 유지.
